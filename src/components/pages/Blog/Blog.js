  ...
  return (
    <section className="dark:bg-coolGray-800 dark:text-coolGray-100">
      ...
      <div className="container mx-auto flex flex-col p-6">
        <h2 className="py-4 text-3xl font-bold text-center">The Questions</h2>
        <div className="divide-y divide-coolGray-700">
          <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
            ...
            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
              ...
              <span className="mt-4 dark:text-coolGray-300">
          ...
          <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
            ...
            <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
              ...
              <span className="mt-4 dark:bg-coolGray-800 dark:text-coolGray-300">
