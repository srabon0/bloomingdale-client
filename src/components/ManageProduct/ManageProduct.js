      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            The Design {item.productName} is great for those looking for a soft, breathable material. It has a tagless neckline, so it won't irritate your skin, and it's designed to have a slim fit.
